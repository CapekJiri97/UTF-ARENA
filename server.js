...
io.on('connection', (socket) => {
  ...
  function joinRoom(roomName) {
      ...
      const allClasses = ['Vanguard', 'Jirina', 'Bruiser', 'Tank', 'Hana', 'Goliath', 'Assassin', 'Runner', 'Kratoma', 'Marksman', 'Mage', 'Summoner', 'Healer', 'Acolyte', 'Keeper'];
  ...
  socket.on('update_selection', (data) => {
    ...
    if (newTeam !== player.team) {
        if (isClassTakenOnNewTeam(player.className)) {
            ...
            const allClassNames = ['Vanguard', 'Jirina', 'Bruiser', 'Tank', 'Hana', 'Goliath', 'Assassin', 'Runner', 'Kratoma', 'Marksman', 'Mage', 'Summoner', 'Healer', 'Acolyte', 'Keeper'];
