export const shopItems = [
  ...
  { id:'as', name:'Dagger', desc:'+20% Attack Speed', cost:300, apply: (pl)=>{ pl.attackSpeed += 0.20 } },
  ...
  { id:'ah', name:'Kindlegem', desc:'+15 Ability Haste', cost:300, apply: (pl)=>{ pl.abilityHaste = (pl.abilityHaste||0) + 15; } }
];